 ...
 *  @return マージされたリスト
 */
struct wordlist merge_list(struct wordlist *s1, struct wordlist *s2,
                           compare_func func) {}
 ...
 *  @return マージソートされたリスト
 */
struct wordlist mergesort_list(struct wordlist *words, int count,
                               compare_func func) {
...
int main(int argc, char *argv[]) {
  ...
  compare_func comp[] = {cmp_asc, cmp_desc};
